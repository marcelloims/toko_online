                ...
                <div class="col">
                    <div class="row">
                        ...
                        <div class="invoice p-3 mb-3">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <?php if ($psn->status_order != 'Accept') : ?>
                                                        <td class="bg-warning">Dalam Proses</td>
                                                    <?php else : ?>
                                                        <td class="bg-success"><?= $psn->status_order ?></td>
                                                    <?php endif; ?>
                                                </tr>
                                            <?php endforeach; ?>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <td><?= ":" ?> <?= $ttl->metode_pembayaran ?></td>
                                            </tr>
                                            <?php if ($ttl->metode_pembayaran != 'Cash') : ?>
                                                <tr>
                                                    <th style="width:50%"> DP </th>
                            ...
                            <a href="<?= base_url() ?>invoice/c_invoice/data_pesanan_pelanggan" class="btn btn-sm btn-danger float-right mb-3">Kembali</a>
                        </div>
                        <!-- Batas Memasukan Konten -->
                    </div>
                </div>
