            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                <li class="nav-item has-treeview menu-open">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?= base_url() ?>member/c_member/dashboard" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Dashboard</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url() ?>member/c_member/data_photographer" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Data Photographer</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url() ?>member/c_member/data_makeup" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Data Makeup Artist</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url() ?>member/c_member/data_endorse" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Data Endorsement</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url() ?>invoice/c_invoice/data_pesanan_member" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Data Pesanan</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= base_url() ?>invoice/c_invoice/data_pembayaran_member" class="nav-link">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Data Pembayaran</p>
                            </a>
                        </li>
