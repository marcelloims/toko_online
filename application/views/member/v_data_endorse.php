            ...
            <div class="container">
                <div class="row">
                    <div class="col">
                        ...
                        <h3 class="m-0 text-dark mb-3 mt-3">Data Tenant Endorsement</h3>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td align="center"><?= $end->tanggal_masuk; ?></td>
                                        <td align="center"><?= $end->tanggal_keluar; ?></td>
                                        <td align="center"><?= $end->keterangan; ?></td>
                                        <td align="center">
                                            <a href="<?= base_url() . 'member/c_member/detail_endorse/' . $end->kode_tenant; ?>" class="btn btn-sm btn-success"><i class="fas fa-info-circle bg-success"></i></a>
                                            <a class="btn btn-sm btn-warning" href="<?= base_url() . 'member/c_member/edit_endorse/' . $end->kode_tenant; ?>"><i class="fas fa-edit bg-warning"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
