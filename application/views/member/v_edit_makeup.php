            ...
            <div class="container">
                <div class="row">
                    <div class="col">
                        ...
                        <h3 class="m-0 text-dark mb-3 mt-3">Form Edit Makeup Artist</h3>
                        <!-- Main content -->
                        <form action="<?php echo base_url() . 'member/c_member/update_makeup' ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <a href="<?= base_url() ?>member/c_member/data_makeup" class="btn btn-sm btn-danger float-right">Kembali</a>
