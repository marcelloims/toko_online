                            ...
                            <div class="card card-solid">
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-6">
                                            <h3 class="my-3">Kode: <?= $endorse->kode_tenant ?> - <?= $endorse->nama_tenant ?></h3>
                                            ...
                                            <div class="bg-light py-2 px-3 mt-4">
                                                <h2 class="mb-0 text-right">
                                                    <strong>Rp. <?= number_format($endorse->harga_tenant, 0,  ',', '.') ?></strong>
                                                </h2>
                                            </div>

                                            <div class="mt-4 float-right">
                                                <a href="<?= base_url() ?>member/c_member/data_endorse" class="btn btn-danger btn-flat mr-2">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="<?= base_url('member/c_member/tambah_foto_endorse/' . $endorse->kode_tenant) ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="modal fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="<?= base_url('member/c_member/tambah_video_endorse/' . $endorse->kode_tenant) ?>" method="post" enctype="multipart/form-data">
                                                            <div class="form-group">
                                            ...
                                            <div class="row mt-3 ml-1 mr-1">
                                                <?php foreach ($photo as $pht) : ?>
                                                    <div class="rounded float-left col-lg-3 ">
                                                        <a href="<?= base_url('member/c_member/hapus_foto_endorse/' . $pht->kode_photo) ?>" class="btn btn-sm btn-danger float-right"><i class="fas fa-close bg-danger"></i></a>
                                            ...
                                            <div class="row  ml-1">
                                                <?php foreach ($video as $vid) : ?>
                                                    <div class="rounded float-left col-lg-3 mb-3">
                                                        <a href="<?= base_url('member/c_member/hapus_video_endorse/' . $vid->kode_video) ?>" class="btn btn-sm btn-danger float-right mt-3"><i class="fas fa-close bg-danger"></i></a>
