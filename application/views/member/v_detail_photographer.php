        ...
        <div class="content-wrapper">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <!-- Batas Konten -->
                        <h3 class="m-0 text-dark mb-3 mt-3">Detail Data Photographer</h3>
                        <!-- Main content -->
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12 col-sm-6">
                                            <div class="col-12">
                                                <img src="<?php echo base_url() . '/uploads_tenant/' . $photographer->logo; ?>" class="product-image" alt="Product Image">
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-6">
                                            <h3 class="my-3">Kode: <?= $photographer->kode_tenant ?> - <?= $photographer->nama_tenant ?></h3>
                                            <h3>ID User<?= $photographer->id_user ?></h3>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-3">
                                                    <h4><?= $photographer->status ?></h4>
                                                </div>
                                                <div class="col-lg-2">
                                                    <h4>Qty : <?= $photographer->qty ?></h4>
                                                </div>
                                                <div class="col-lg-7">
                                                    <h4>Kategori : <?= $photographer->kategori ?></h4>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <h5><?= $photographer->alamat_tenant ?>, <?= $photographer->kecamatan ?>. <?= $photographer->kabupaten ?> - <?= $photographer->provinsi ?></h5>
                                                </div>
                                            </div>

                                            <div class="bg-light py-2 px-3 mt-4">
                                                <h2 class="mb-0 text-right">
                                                    <strong>Rp. <?= number_format($photographer->harga_tenant, 0,  ',', '.') ?></strong>
                                                </h2>
                                            </div>

                                            <div class="mt-4 float-right">
                                                <a href="<?= base_url() ?>member/c_member/data_photographer" class="btn btn-danger btn-flat mr-2">
                                                    <i class="fa fa-arrow-left bg-danger" aria-hidden="true"> </i>Back
                                                </a>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="<?= base_url('member/c_member/tambah_foto_photographer/' . $photographer->kode_tenant) ?>" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="kode_tenant" class="form-control" id="formGroupExampleInput2" placeholder="Kode Tenant" value="<?= $photographer->kode_tenant ?>" readonly>
                                                            </div>
                                                    </div>
                                        ...
                                        <div class="modal fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="<?= base_url('member/c_member/tambah_video_photographer/' . $photographer->kode_tenant) ?>" method="post" enctype="multipart/form-data">
                                                            <div class="form-group">
                                            ...
                                            <div class="row mt-3 ml-1 mr-1">
                                                <?php foreach ($photo as $pht) : ?>
                                                    <div class="rounded float-left col-lg-3 ">
                                                        <a href="<?= base_url('member/c_member/hapus_foto_photographer/' . $pht->kode_photo) ?>" class="btn btn-sm btn-danger float-right"><i class="fas fa-close bg-danger"></i></a>
                                            ...
                                            <div class="row  ml-1">
                                                <?php foreach ($video as $vid) : ?>
                                                    <div class="rounded float-left col-lg-3 mb-3">
                                                        <a href="<?= base_url('member/c_member/hapus_video_photographer/' . $vid->kode_video) ?>" class="btn btn-sm btn-danger float-right mt-3"><i class="fas fa-close bg-danger"></i></a>
