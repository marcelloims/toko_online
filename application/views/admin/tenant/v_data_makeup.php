                    ...
                    <div class="col">
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="<?php echo base_url() . 'admin/c_admin/tambah_makeup' ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <table class="table table-hover" id="example1">
                            ...
                            <tbody>
                                <?php
                                $no = 1;
                                foreach ($makeup as $mk) :
                                ?>
                                    <tr>
                                        <th scope="row" align="center"><?= $no++ ?></th>
                                        <td align="center"><?= $mk->kode_tenant; ?></td>
                                        <td><?= $mk->nama_tenant; ?></td>
                                        <td align="center"><?= $mk->tanggal_masuk; ?></td>
                                        <td align="center"><?= $mk->tanggal_keluar; ?></td>
                                        <td align="center"><?= $mk->keterangan; ?></td>
                                        <td align="center">
                                            <a class="btn btn-sm btn-success" href="<?= base_url() . 'admin/c_admin/detail_makeup/' . $mk->kode_tenant; ?>"><i class="fas fa-info-circle bg-success"></i></a>
                                            <a class="btn btn-sm btn-warning" href="<?= base_url() . 'admin/c_admin/edit_makeup/' . $mk->kode_tenant; ?>"><i class="fas fa-edit bg-warning"></i></a>
                                            <a class="btn btn-sm btn-danger" onclick="return confirm('Anda Yakin Ingin HAPUS Data ini?')" href="<?= base_url() . 'admin/c_admin/hapus_makeup/' . $mk->kode_tenant; ?>"><i class="fas fa-trash bg-red"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
