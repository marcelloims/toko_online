            ...
            <div class="container">
                <div class="row">
                    <div class="col">
                        ...
                        <!-- Main content -->
                        <form action="<?php echo base_url() . 'admin/c_admin/update_makeup' ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <a href="<?= base_url() ?>admin/c_admin/data_makeup" class="btn btn-sm btn-danger float-right">Kembali</a>
