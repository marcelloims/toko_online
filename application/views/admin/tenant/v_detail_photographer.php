                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-6">
                                            ...
                                            <div class="mt-4 float-right">
                                                <a href="<?= base_url() ?>admin/c_admin/data_photographer" class="btn btn-danger btn-flat mr-2">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="<?= base_url('admin/c_admin/tambah_foto_photographer/' . $photographer->kode_tenant) ?>" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="modal fade" id="exampleModal1" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="<?= base_url('admin/c_admin/tambah_video_photographer/' . $photographer->kode_tenant) ?>" method="post" enctype="multipart/form-data">
                                                            <div class="form-group">
                                            ...
                                            <div class="row mt-3 ml-1 mr-1">
                                                <?php foreach ($photo as $pht) : ?>
                                                    <div class="rounded float-left col-lg-3 ">
                                                        <a href="<?= base_url('admin/c_admin/hapus_foto_photographer/' . $pht->kode_photo) ?>" class="btn btn-sm btn-danger float-right"><i class="fas fa-close bg-danger"></i></a>
                                            ...
                                            <div class="row  ml-1">
                                                <?php foreach ($video as $vid) : ?>
                                                    <div class="rounded float-left col-lg-3 mb-3">
                                                        <a href="<?= base_url('admin/c_admin/hapus_video_photographer/' . $vid->kode_video) ?>" class="btn btn-sm btn-danger float-right mt-3"><i class="fas fa-close bg-danger"></i></a>
