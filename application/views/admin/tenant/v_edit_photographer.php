            ...
            <div class="container">
                <div class="row">
                    <div class="col">
                        ...
                        <!-- Main content -->
                        <form action="<?php echo base_url() . 'admin/c_admin/update_photographer' ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <a href="<?= base_url() ?>admin/c_admin/data_photographer" class="btn btn-sm btn-danger float-right">Kembali</a>
