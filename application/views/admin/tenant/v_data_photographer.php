                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="<?php echo base_url() . 'admin/c_admin/tambah_photographer' ?>" method="POST" enctype="multipart/form-data">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a href="<?= base_url() . 'admin/c_admin/detail_photographer/' . $pht->kode_tenant; ?>" class="btn btn-sm btn-success"><i class="fas fa-info-circle bg-success"></i></a>
                                            <a class="btn btn-sm btn-warning" href="<?= base_url() . 'admin/c_admin/edit_photographer/' . $pht->kode_tenant; ?>"><i class="fas fa-edit bg-warning"></i></a>
                                            <a class="btn btn-sm btn-danger" onclick="return confirm('Anda Yakin Ingin HAPUS Data ini?')" href="<?= base_url() . 'admin/c_admin/hapus_photographer/' . $pht->kode_tenant; ?>"><i class="fas fa-trash bg-red"></i></a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
